...
$GLOBALS['TL_LANG']['tl_nc_gateway']['pdfnc_fileext']       = array('Dateinamen erweitern', 'Ergänzen Sie den Dateinamen mit InsertTags, z.B. {{date::ymd_His}}, um ihn eindeutig zu machen.');
